...
class Gae_Frontend
{
    ...
    public static function add_inline_scripts()
    {
        ...
        if (!empty($ga_id) && $ga_type !== 0) {
            switch ($ga_type) {
                ...
                case "tag-manager":
                    ...
                    <script async src="https://www.googletagmanager.com/gtag/js?id=<?= trim($ga_id) ?>"></script>
                    <script>
                ...
                case "analytics":
                    ...
                    <script>
                      ...
                      ga('create', '<?php echo trim($ga_id); ?>', 'auto');
                      ga('send', 'pageview');
        ...
        <script>
          ...
          var GAE_DEBUG_LEVEL = 0;

          <?php if (Gae_Admin::debug() > 0): ?>
          GAE_DEBUG_LEVEL = '<?= Gae_Admin::debug() ?>';
          <?php endif; ?>

          <?php if (Gae_Admin::debug_admin() > 0): ?>
          GAE_DEBUG_LEVEL = '<?= Gae_Admin::debug_admin() ?>';
          <?php endif; ?>
